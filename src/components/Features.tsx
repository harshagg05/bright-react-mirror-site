...
const Features = () => {
  const features = [
    {
      icon: <Search className="h-8 w-8 text-primary mx-auto mb-4" />,
    ...
    {
      icon: <Leaf className="h-8 w-8 text-primary mx-auto mb-4" />,
    ...
    <section className="py-16 bg-accent">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-center text-gray-600 mb-12 max-w-3xl mx-auto">
          Our digital platform offers an immersive experience to learn about medicinal plants used in 
